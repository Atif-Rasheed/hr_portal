...
class JobTemplate(models.Model):
    ...
    canned_languages = models.CharField(max_length=10, choices=CANNED_FIELDS_CHOICES, default=0,help_text="Language Spoken")
    ...
    canned_citizen = models.CharField(max_length=10, choices=CANNED_FIELDS_CHOICES, default=0,help_text="Citizen/Employment Status")
    canned_education = models.CharField(max_length=10, choices=CANNED_FIELDS_CHOICES, default=0,help_text="Highest Education Obtained")
    canned_college = models.CharField(max_length=10, choices=CANNED_FIELDS_CHOICES, default=0,help_text="College/University")
    canned_gpa = models.CharField(max_length=10, choices=CANNED_FIELDS_CHOICES, default=0,help_text="Grade Point Average(GPA)")
    canned_over18 = models.CharField(max_length=10, choices=CANNED_FIELDS_CHOICES, default=0,help_text="Age 18 or Older")
    ...
    canned_felony = models.CharField(max_length=10, choices=CANNED_FIELDS_CHOICES, default=0,help_text="Felony Conviction")
